  ...
  public override fun observeRequestsForDistrict(districtId: String):
    ...
    return createFlow(__db, false, arrayOf("verification_requests")) { _connection ->
      ...
      try {
        ...
        val _cursorIndexOfRequesterPubKey: Int = getColumnIndexOrThrow(_stmt, "requesterPubKey")
        val _cursorIndexOfRequesterDisplayName: Int = getColumnIndexOrThrow(_stmt,
        ...
        val _cursorIndexOfStateId: Int = getColumnIndexOrThrow(_stmt, "stateId")
        ...
        val _cursorIndexOfHandledByPubKey: Int = getColumnIndexOrThrow(_stmt, "handledByPubKey")
        ...
        while (_stmt.step()) {
          ...
          _tmpRequesterPubKey = _stmt.getText(_cursorIndexOfRequesterPubKey)
          val _tmpRequesterDisplayName: String
          _tmpRequesterDisplayName = _stmt.getText(_cursorIndexOfRequesterDisplayName)
          ...
          _tmpStateId = _stmt.getText(_cursorIndexOfStateId)
          ...
          val _tmp: String
          _tmp = _stmt.getText(_cursorIndexOfStatus)
          _tmpStatus = __civicConverters.toVerificationRequestStatus(_tmp)
          val _tmpHandledByPubKey: String?
          if (_stmt.isNull(_cursorIndexOfHandledByPubKey)) {
            _tmpHandledByPubKey = null
          } else {
            _tmpHandledByPubKey = _stmt.getText(_cursorIndexOfHandledByPubKey)
          }
