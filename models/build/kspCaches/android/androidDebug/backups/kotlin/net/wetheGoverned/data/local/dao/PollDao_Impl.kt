  ...
  public override fun observePolls(districtId: String): Flow<List<DistrictPollEntity>> {
    ...
    return createFlow(__db, false, arrayOf("district_polls")) { _connection ->
      ...
      try {
        ...
        val _columnIndexOfUserImportanceVote: Int = getColumnIndexOrThrow(_stmt,
            "userImportanceVote")
        val _columnIndexOfResidentVoteOption: Int = getColumnIndexOrThrow(_stmt,
            "residentVoteOption")
        val _columnIndexOfLinkedLegislationId: Int = getColumnIndexOrThrow(_stmt,
            "linkedLegislationId")
        val _columnIndexOfDistrictBreakdownJson: Int = getColumnIndexOrThrow(_stmt,
