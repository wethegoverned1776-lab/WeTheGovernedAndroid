  ...
  public override fun observeDistrict(districtId: String): Flow<DistrictEntity?> {
    ...
    return createFlow(__db, false, arrayOf("districts")) { _connection ->
      ...
      try {
        ...
        val _columnIndexOfRepresentativeName: Int = getColumnIndexOrThrow(_stmt,
            "representativeName")
        val _columnIndexOfRepresentativeParty: Int = getColumnIndexOrThrow(_stmt,
            "representativeParty")
        val _columnIndexOfGeoBoundaries: Int = getColumnIndexOrThrow(_stmt, "geoBoundaries")
        ...
        if (_stmt.step()) {
          ...
          if (_stmt.isNull(_columnIndexOfGeoBoundaries)) {
            _tmpGeoBoundaries = null
          } else {
            _tmpGeoBoundaries = _stmt.getText(_columnIndexOfGeoBoundaries)
          }
