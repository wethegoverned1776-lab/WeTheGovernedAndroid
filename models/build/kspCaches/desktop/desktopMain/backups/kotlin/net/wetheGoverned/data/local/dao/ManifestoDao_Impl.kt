  ...
  public override fun observeManifestos(districtId: String): Flow<List<CandidateManifestoEntity>> {
    ...
    return createFlow(__db, false, arrayOf("candidate_manifestos")) { _connection ->
      ...
      try {
        ...
        val _cursorIndexOfCandidatePubKey: Int = getColumnIndexOrThrow(_stmt, "candidatePubKey")
        ...
        val _cursorIndexOfBody: Int = getColumnIndexOrThrow(_stmt, "body")
        val _cursorIndexOfPublishedAt: Int = getColumnIndexOrThrow(_stmt, "publishedAt")
        ...
        while (_stmt.step()) {
          ...
          _tmpCandidatePubKey = _stmt.getText(_cursorIndexOfCandidatePubKey)
          ...
          val _tmpBody: String
          _tmpBody = _stmt.getText(_cursorIndexOfBody)
          val _tmpPublishedAt: Long
          _tmpPublishedAt = _stmt.getLong(_cursorIndexOfPublishedAt)
  ...
  public override suspend fun getQuestions(manifestoId: String): List<ManifestoQuestionEntity> {
    ...
    return performSuspending(__db, true, false) { _connection ->
      ...
      try {
        ...
        _stmt.bindText(_argIndex, manifestoId)
        val _cursorIndexOfId: Int = getColumnIndexOrThrow(_stmt, "id")
        val _cursorIndexOfManifestoId: Int = getColumnIndexOrThrow(_stmt, "manifestoId")
        val _cursorIndexOfAskerPubKey: Int = getColumnIndexOrThrow(_stmt, "askerPubKey")
        val _cursorIndexOfText: Int = getColumnIndexOrThrow(_stmt, "text")
        val _cursorIndexOfAskedAt: Int = getColumnIndexOrThrow(_stmt, "askedAt")
        val _cursorIndexOfAnswer: Int = getColumnIndexOrThrow(_stmt, "answer")
        val _cursorIndexOfAnsweredAt: Int = getColumnIndexOrThrow(_stmt, "answeredAt")
        ...
        while (_stmt.step()) {
          ...
          _tmpManifestoId = _stmt.getText(_cursorIndexOfManifestoId)
          val _tmpAskerPubKey: String
          _tmpAskerPubKey = _stmt.getText(_cursorIndexOfAskerPubKey)
          val _tmpText: String
          _tmpText = _stmt.getText(_cursorIndexOfText)
          val _tmpAskedAt: Long
          _tmpAskedAt = _stmt.getLong(_cursorIndexOfAskedAt)
          val _tmpAnswer: String?
          if (_stmt.isNull(_cursorIndexOfAnswer)) {
            _tmpAnswer = null
          } else {
            _tmpAnswer = _stmt.getText(_cursorIndexOfAnswer)
          }
          val _tmpAnsweredAt: Long?
          if (_stmt.isNull(_cursorIndexOfAnsweredAt)) {
            _tmpAnsweredAt = null
          } else {
            _tmpAnsweredAt = _stmt.getLong(_cursorIndexOfAnsweredAt)
          }
          _item =
