  ...
  public override fun observeMetrics(districtId: String): Flow<List<DistrictMetricEntity>> {
    ...
    return createFlow(__db, false, arrayOf("district_metrics")) { _connection ->
      ...
      try {
        ...
        val _cursorIndexOfResidentValue: Int = getColumnIndexOrThrow(_stmt, "residentValue")
        val _cursorIndexOfUnit: Int = getColumnIndexOrThrow(_stmt, "unit")
        val _cursorIndexOfSource: Int = getColumnIndexOrThrow(_stmt, "source")
        val _cursorIndexOfReportedAt: Int = getColumnIndexOrThrow(_stmt, "reportedAt")
        val _cursorIndexOfReporterPubKey: Int = getColumnIndexOrThrow(_stmt, "reporterPubKey")
        ...
        while (_stmt.step()) {
          ...
          if (_stmt.isNull(_cursorIndexOfResidentValue)) {
            _tmpResidentValue = null
          } else {
            _tmpResidentValue = _stmt.getText(_cursorIndexOfResidentValue)
          }
          val _tmpUnit: String
          _tmpUnit = _stmt.getText(_cursorIndexOfUnit)
          ...
          _tmpReportedAt = _stmt.getLong(_cursorIndexOfReportedAt)
          val _tmpReporterPubKey: String?
          if (_stmt.isNull(_cursorIndexOfReporterPubKey)) {
            _tmpReporterPubKey = null
          } else {
            _tmpReporterPubKey = _stmt.getText(_cursorIndexOfReporterPubKey)
          }
