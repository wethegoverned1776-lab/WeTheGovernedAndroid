...
open class TierVerificationViewModel(
    ...
    fun startVerificationFlow() {
        ...
        viewModelScope.launch {
            ...
            val fedDistrict = resolution.federalDistrict
            if (fedDistrict == null) {
            ...
            _uiState.update { it.copy(
                detectedCongressional = fedDistrict.displayName,
            ...
            val effectiveDistrictId = userDistrictId ?: fedDistrict.id
            ...
            if (!isRegistered) {
                ...
                _uiState.update { it.copy(state = VerificationState.FAILED, error = "Registration Not Found: No matching voter in ${fedDistrict.displayName} records.") }
                return@launch
            }
            ...
            if (userDistrictId != null && !fedDistrict.id.equals(userDistrictId, ignoreCase = true)) {
                _uiState.update { it.copy(state = VerificationState.FAILED, error = "District Mismatch: This address is in ${fedDistrict.displayName}, but you registered for $userDistrictId.") }
                return@launch
            }

            completeVerification(pubKey, fedDistrict.id, addressFingerprint, null)
        }
    }
